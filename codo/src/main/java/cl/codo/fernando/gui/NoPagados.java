 ...
 * @author fernando
 */
public class NoPagados extends javax.swing.JFrame {

    /**
     * Creates new form NoPagados
     */
    public NoPagados() {
        initComponents();   
        ...
        List<cl.codo.fernando.modelo.vista> vistas = servicio.getdatosnopagados(fecha);
        if(!vistas.isEmpty()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NoPagados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
